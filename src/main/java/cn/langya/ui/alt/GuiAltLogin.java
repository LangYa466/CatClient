...
public abstract class GuiAltLogin extends GuiScreen {
    ...
    public void drawScreen(int x, int y, float z) {
        ...
        FontManager.hanYi().drawCenteredStringWithShadow(status, (float) (this.width / 2), (this.height / 4F + 24) + 38, -1);
        if (this.username.getText().isEmpty() && !this.username.isFocused()) {
            FontManager.hanYi().drawStringWithShadow("用户名", (float)(this.width / 2 - 96), (this.height / 4F + 24) + 72 - 4, -7829368);
        }
