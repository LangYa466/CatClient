...
public class WorldRenderUtil implements Wrapper {
    ...
    public static void drawRects(double left, double top, double right, double bottom, Color color) {
        WorldRenderUtil.enableGL2D();
        WorldRenderUtil.glColor(color);
        WorldRenderUtil.drawRectZZ(left, top, right, bottom);
        WorldRenderUtil.disableGL2D();
    }
    ...
    public static void drawExeterCrossESP(int rgb, double x, double y, double z) {
        ...
        WorldRenderUtil.enableGL3D(1.0F); // line width

        WorldRenderUtil.setColor(rgb);

        WorldRenderUtil.drawOutlinedBoundingBox(axisAlignedBB);

        WorldRenderUtil.disableGL3D();
        GlStateManager.popMatrix();
    }
    ...
    public static void drawLaserPoint(int rgb, double posX, double posY, double posZ) {
        GL11.glPushMatrix();
        enableGL3D(2.0F);
        WorldRenderUtil.setColor(new Color(255, 0, 0).getRGB());
        GL11.glBegin(2);
