...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleExplosion(S27PacketExplosion packetIn)
    {
        ...
        this.gameController.thePlayer.motionX += (double)packetIn.motionX;
        this.gameController.thePlayer.motionY += (double)packetIn.motionY;
        this.gameController.thePlayer.motionZ += (double)packetIn.motionZ;
    }
